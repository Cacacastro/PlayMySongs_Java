...
public class RecebeDados extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String mensagem = "Musica armazenada com sucesso!";
        try
        {
            ...
            if(musica.length()<2 || cantor.length()<2)
                throw new Exception(mensagem = "Musica ou Cantor nao preenchido corretamente!");
            else
            {
                // recebe a foto
                ...
                raf = new RandomAccessFile(request.getServletContext().getRealPath("")+"//musicas.txt","rw");
                raf.seek(raf.length());
        ...
        }catch(Exception e){mensagem="Erro ao armazenar a musica!";}
